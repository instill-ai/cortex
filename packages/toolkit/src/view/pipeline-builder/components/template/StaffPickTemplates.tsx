    ...
    >
      <div className="flex flex-row px-4 py-2 border-b border-semantic-bg-line">
        ...
        >
          ...
          <g clip-path="url(#clip2_195_13750)">
            <path
          ...
          <g clip-path="url(#clip3_195_13750)">
            <path
          ...
          <g clip-path="url(#clip8_195_13750)">
            <path
