...
- NEXT_PUBLIC_BASE_API_GATEWAY_BASE_URL (string)
- NEXT_SERVER_BASE_API_GATEWAY_BASE_URL (string)
- NEXT_PUBLIC_MODEL_API_GATEWAY_BASE_URL (string)
- NEXT_SERVER_MODEL_API_GATEWAY_BASE_URL (string)
- NEXT_PUBLIC_VDP_API_GATEWAY_BASE_URL (string)
- NEXT_SERVER_VDP_API_GATEWAY_BASE_URL (string)
